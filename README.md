...
Das ADAM Web Frontend auf [https://github.com/mbalabanov/adam](https://github.com/mbalabanov/adam) ist eine Angular Universal SSR App (Server Side Rendering). So startet man die App lokal  (läuft auf Port 4200):
```
cd adam
npm install
npm run dev:ssr
